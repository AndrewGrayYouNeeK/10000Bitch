    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const PAPER_X_OFFSET = { 1: -2, 2: size * 0.01 - 11, 3: size * 0.01, 5: size * 0.01, 6: size * 0.01 };
          const PAPER_Y_OFFSET = { 1: -size * 0.015 + 2, 2: -size * 0.015 + 3, 3: -size * 0.02, 4: -size * 0.04, 5: -size * 0.04, 6: -size * 0.04 };
