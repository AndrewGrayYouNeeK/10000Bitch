    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const LEATHER_X_OFFSET = { 1: -size * 0.01, 2: -size * 0.13, 3: -size * 0.25, 4: -size * 0.01, 5: -size * 0.08, 6: -size * 0.11 };
          const LEATHER_Y_OFFSET = { 1: size * 0.01, 2: size * 0.02, 3: size * 0.04, 4: -size * 0.02, 5: -size * 0.01, 6: -size * 0.01 };
