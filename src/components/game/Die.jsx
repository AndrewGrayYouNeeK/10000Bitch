    ...
    <motion.div
      ...
      <button
        ...
        {skin.videoUrl && (() => {
          ...
          const FACE_TX_OFFSET = { 1: -0.3, 2: -3.8, 3: -7.0, 4: -1.3, 5: -3.0, 6: -6.8 };
          const FACE_TY_OFFSET = { 1: 0.1, 2: 0, 3: 0, 4: -3, 5: -3, 6: -3 };
        ...
        (() => {
          ...
          const PLASMA_X_OFFSET = { 1: -size * 0.04, 2: -size * 0.09, 3: -size * 0.14, 4: -size * 0.02, 5: -size * 0.10, 6: -size * 0.15 };
          const PLASMA_Y_OFFSET = { 1: size * 0.005, 2: -size * 0.01, 3: -size * 0.01, 4: -size * 0.06, 5: -size * 0.03, 6: -size * 0.045 };
