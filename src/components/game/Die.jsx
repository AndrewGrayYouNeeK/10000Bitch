    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const AQUA_LIGHT_X_OFFSET = { 1: 0, 2: -size * 0.02, 3: -size * 0.04, 4: size * 0.01, 5: -size * 0.02, 6: -size * 0.03 };
          const AQUA_LIGHT_Y_OFFSET = { 1: 0, 2: -size * 0.005, 3: 0, 4: -size * 0.03, 5: -size * 0.04, 6: -size * 0.03 };
