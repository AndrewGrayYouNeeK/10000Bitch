    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const MARBLE_X_OFFSET = { 1: size * 0.01, 2: size * 0.015, 3: size * 0.005, 4: size * 0.005, 5: size * 0.005, 6: size * 0.015 };
          const MARBLE_Y_OFFSET = { 1: -size * 0.005, 2: -size * 0.01, 3: -size * 0.005, 4: -size * 0.015, 5: -size * 0.015, 6: -size * 0.015 };
