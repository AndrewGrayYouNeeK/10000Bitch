    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const PLASMA_X_OFFSET = { 1: -size * 0.02, 2: -size * 0.06, 3: -size * 0.11, 4: -size * 0.01, 5: -size * 0.02, 6: -size * 0.05 };
          const PLASMA_Y_OFFSET = { 1: size * 0.04, 2: size * 0.02, 3: size * 0.02, 4: -size * 0.04, 6: -size * 0.015 };
