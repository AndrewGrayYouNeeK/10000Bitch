    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const MOONSTONE_X_OFFSET = { 2: size * 0.005, 3: size * 0.005, 4: size * 0.005, 5: size * 0.005, 6: size * 0.005 };
          const MOONSTONE_Y_OFFSET = { 1: -size * 0.005, 2: -size * 0.015, 3: -size * 0.005, 4: size * 0.005, 5: size * 0.005, 6: size * 0.005 };
