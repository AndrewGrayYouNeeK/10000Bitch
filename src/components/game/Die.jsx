    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const PRIDE_X_OFFSET = { 1: -size * 0.01, 2: -size * 0.12, 3: -size * 0.20, 4: -size * 0.02, 5: -size * 0.12, 6: -size * 0.20 };
          const PRIDE_Y_OFFSET = { 2: size * 0.02, 3: size * 0.04, 4: -size * 0.05, 5: -size * 0.01, 6: -size * 0.01 };
