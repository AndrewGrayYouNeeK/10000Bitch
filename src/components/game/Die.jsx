    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const LOVE_X_OFFSET = { 2: -size * 0.03, 3: size * 0.01, 5: size * 0.01, 6: size * 0.01 };
          const LOVE_Y_OFFSET = { 1: -size * 0.005, 2: -size * 0.015, 3: -size * 0.02, 4: -size * 0.04, 5: -size * 0.04, 6: -size * 0.04 };
