    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const TENNIS_X_OFFSET = { 1: -size * 0.02, 2: -size * 0.13, 3: -size * 0.23, 4: -size * 0.03, 5: -size * 0.14, 6: -size * 0.24 };
          const TENNIS_Y_OFFSET = { 4: -size * 0.07, 5: -size * 0.07, 6: -size * 0.07 };
