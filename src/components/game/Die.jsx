    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const LOVE_X_OFFSET = { 2: -size * 0.11, 3: -size * 0.23, 5: size * 0.01, 6: size * 0.01 };
          const LOVE_Y_OFFSET = { 1: -size * 0.005, 2: -size * 0.005, 3: -size * 0.01, 4: -size * 0.04, 5: -size * 0.04, 6: -size * 0.04 };
