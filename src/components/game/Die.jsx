    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const CRYSTAL_CUT_X_OFFSET = { 2: -size * 0.0925, 3: -size * 0.175, 4: -size * 0.03, 5: -size * 0.09, 6: -size * 0.145 };
          const CRYSTAL_CUT_Y_OFFSET = { 4: -size * 0.045, 5: -size * 0.0075, 6: -size * 0.015 };
