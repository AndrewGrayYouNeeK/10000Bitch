    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const MOONSTONE_X_OFFSET = { 1: size * 0.015, 2: size * 0.02, 3: size * 0.02, 4: size * 0.025, 5: size * 0.02, 6: size * 0.02 };
          const MOONSTONE_Y_OFFSET = { 1: size * 0.01, 2: size * 0.005, 3: size * 0.0075, 4: -size * 0.007, 5: -size * 0.007, 6: -size * 0.007 };
          ...
          const stretch = skin.id === "moonstone" ? size * 0.0375 : 0;
          return (
            <div
