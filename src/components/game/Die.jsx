    ...
    <motion.div
      ...
      <button
        ...
        (() => {
          ...
          const LAVA_X_OFFSET = { 2: -size * 0.035, 3: -size * 0.035, 5: size * 0.015, 6: size * 0.015 };
          const LAVA_Y_OFFSET = { 1: -size * 0.035, 2: -size * 0.035, 3: -size * 0.035, 4: -size * 0.045, 5: -size * 0.015, 6: -size * 0.015 };
